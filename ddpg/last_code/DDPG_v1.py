...
class DDPG(object):
    ...
    def _build_a(self, s, scope, trainable):
        ...
        with tf.variable_scope(scope):
            ...
            net3 = tf.layers.dropout(net3, rate=0.2, training=self.a_is_training)
    ...
    def _build_c(self, s, a, scope, trainable):
        ...
        with tf.variable_scope(scope):
            ...
            net1 = tf.nn.leaky_relu(tf.matmul(s, w1_s) + tf.matmul(a, w1_a) + b1)
            ...
            net4 = tf.layers.dropout(net4, rate=0.2, training=self.c_is_training)
